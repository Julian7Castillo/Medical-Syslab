...
<html>
	...
	<body>
		<article>
			<center><br><h1> Actualizar datos de Citas </h1><br><br></center>

			<FORM action= "" method="post" class="form-horizontal">
				<P><h3><b>Datos </b></center><br><br></h3>
				<div class="form-group">
					<label class="control-label col-md-2"> Id de Cita: </label>
					<div class="col-md-10">
						<INPUT class="form-control" type="text" name="idcit" placeholder="CC"></INPUT></P>
					</div>					
				</div>
		 ...
		 <?php
			...
			?>
			  <tr>
			    ...
			    <td><a href="inicio.php?pag=Edicion_Citas&idCita=<?php echo $registro->idCita?>">
