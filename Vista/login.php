			...
			<section class="main row center-di" >
				<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
					...
					<form class="center-div" action="controlador/LoginController.php" mothod="post">
						...
						<INPUT type="text" name="usuarioMedicalSyslab"><br><br>

						<p class="center-div">Contraseña: </p><br>
						<INPUT class="password" type="password" id="password_hash" name ="pswMedicalSyslab">

						<button id="togglePassword" class="btn btn-primary btn-lg" type="button" onclick="mostrar()">
