...
<html lang="en">
    ...
    <body>
        ...
        <footer class=" flex responsive">

            <section id="Contactanos" class="center formulario">
                <h3 class="textcenterhorizontal">Contactanos</h3>
                <form action="https://formsubmit.co/1e69c37e6faf93e637332ac5e1a06813" method="POST">
                    <div class="flex">
                        <fieldset>
                            <legend class="text-white">Datos personales</legend> 

                            <label for="Nombre">Nombre: </label>
                            <input class="text-black" type="text" name="Nombre"><br>

                            <label for="Apellido">Apellido: </label>
                            <input class="text-black" name="Apellido" type="text">
                        </fieldset>

                        <fieldset>
                            <legend class="text-white">Datos de contacto</legend> 

                            <label for="email">Correo Electronico: </label>
                            <input class="text-black" name="email" type="Correo"><br>

                            <label for="Celular">Telefono: </label>
                            <input class="text-black" name="Celular" type="number"><br>

                            <label for="Tema a tratar">Tema a tratar: </label><br>
                            <textarea class="text-black" name="Tema a tratar" type="text"></textarea><br>

                        </fieldset>
                    </div>
                    <button class="btn-formulario btn btn-primary btn-lg" type="submit">Enviar Formulario</button>
                </form>
            </section>    

            <div class="text-center">
                <h3 class="redes-titulo">Visita nuestras redes sociales.</h3>
                <i class="bi bi-facebook"></i>

                <div class="flex around responsive">
